...
export default function YanoAIPage() {
  ...
  // This effect runs on the client after hydration, ensuring the year is up-to-date
      ...
      <footer className="bg-neutral-900 text-white">
        <div className="container mx-auto px-6 py-12">
          ...
          <div className="mt-12 border-t border-neutral-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-500">&copy; {currentYear} Yano AI Technologies. All rights reserved.</p>
