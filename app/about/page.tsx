...
const WhoWeArePage = () => {
  ...
  const leadershipTeam = [
    ...
    },
    {
      ...
      image: 'https://github.com/Yano-ai/yano-ai.github.io/blob/yaowillart-design-patch-1/willart%20yao.png',     social: { linkedin: '#', github: 'https://github.com/willartyao-design' }
    }
  ];
